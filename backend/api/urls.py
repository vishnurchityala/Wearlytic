...
urlpatterns = [
    ...
    path('users/me/generations/', list_generations, name='list_generations'),
	...
	path('catalog/metadata/', catalog_metadata_view, name='catalog_metadata'),
