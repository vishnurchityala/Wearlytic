...
class Batch(BaseModel):
    ...
    - batch_size (int): Number of product URLs in the batch.  
        Example: 10
    - urls (List[ProductUrl]): List of product URL objects associated with the batch.  
        Example: [ProductUrl(id="url_1"), ProductUrl(id="url_2")]
    ...
    urls: List[ProductUrl] = Field(..., description="List of product URL objects associated with the batch.")
